...
function send_products() {
    ...
    $result['test'] = json_encode(get_current_filters());
                            ...
                            echo wp_sprintf(
                                ...
                                foreach ($filters['second_term']['terms'] as $term) {
                                    ...
                                    if($term['categories']) {
                                        ...
                                        echo sprintf(
                                            '<ul data-filter="%s" data-title="">',
                                            $filters['second_term']['tax'],
                                            $filters['second_term']['tax'] == 'kolekcje' ? __('Kolekcja', 'decobelo') : __('Produkt', 'decobelo')
                                        );

                                            foreach ($term['categories'] as $term) {
                                                
                                                echo wp_sprintf(
                                                    '<li>
                                                        <a href="" data-value="%s" data-type="%s" class="filter">%s</a>
                                                    </li>',
                                                    $term['slug'],
                                                    $filters['second_term']['tax'],
                                                    $term['name']
...
function change_filters($filters=null) {
