...
<header class="woocommerce-products-header">
	<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
		<h1 class="woocommerce-products-header__title page-title"><?php _e('Najnowsze produkty', 'decobelo')?></h1>
	<?php endif; ?>
	...
	<?php 
		...
		render_filters($current_filters, $current_vars, true);
